...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Requested Checks Lista',
  'LBL_MODULE_NAME' => 'Requested Checks',
  'LBL_MODULE_TITLE' => 'Requested Checks',
  'LBL_MODULE_NAME_SINGULAR' => 'Requested Check',
  'LBL_HOMEPAGE_TITLE' => 'Saját Requested Checks',
  'LNK_NEW_RECORD' => 'Új létrehozása Requested Check',
  'LNK_LIST' => 'Megtekintés Requested Checks',
  'LNK_IMPORT_RRRC_REQUESTED_CHECKS' => 'Import Requested Checks',
  'LBL_SEARCH_FORM_TITLE' => 'Keresés Requested Check',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Előzmények megtekintése',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Tevékenységek',
  'LBL_RRRC_REQUESTED_CHECKS_SUBPANEL_TITLE' => 'Requested Checks',
  'LBL_NEW_FORM_TITLE' => 'Új Requested Check',
  'LNK_IMPORT_VCARD' => 'Import Requested Check vCard',
  'LBL_IMPORT' => 'Import Requested Checks',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new Requested Check record by importing a vCard from your file system.',
);
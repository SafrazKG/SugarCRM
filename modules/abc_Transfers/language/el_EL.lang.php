...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Transfers Λίστα',
  'LBL_MODULE_NAME' => 'Transfers',
  'LBL_MODULE_TITLE' => 'Transfers',
  'LBL_MODULE_NAME_SINGULAR' => 'Transfer',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου Transfers',
  'LNK_NEW_RECORD' => 'Δημιουργία Transfer',
  'LNK_LIST' => 'Προβολή Transfers',
  'LNK_IMPORT_ABC_TRANSFERS' => 'Import Transfers',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Transfer',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
  'LBL_ABC_TRANSFERS_SUBPANEL_TITLE' => 'Transfers',
  'LBL_NEW_FORM_TITLE' => 'Νέα Transfer',
